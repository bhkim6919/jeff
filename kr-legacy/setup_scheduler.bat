...
schtasks /create /tn "Q-TRON_TradingDayCheck" /tr "C:\Q-TRON-32_ARCHIVE\kr-legacy\00_check_trading_day.bat" /sc daily /st 07:52 /rl HIGHEST /f
if errorlevel 1 (
...
schtasks /create /tn "Q-TRON_MorningBatch" /tr "C:\Q-TRON-32_ARCHIVE\kr-legacy\01_batch_scheduled.bat" /sc weekly /d MON,TUE,WED,THU,FRI /st 07:55 /rl HIGHEST /f
if errorlevel 1 (
...
schtasks /create /tn "Q-TRON_AutoStart" /tr "C:\Q-TRON-32_ARCHIVE\.venv\Scripts\python.exe C:\Q-TRON-32_ARCHIVE\kr-legacy\auto_start.py" /sc weekly /d MON,TUE,WED,THU,FRI /st 08:30 /rl HIGHEST /f
if errorlevel 1 (
...
schtasks /create /tn "Q-TRON_RESTMonitor" /tr "C:\Q-TRON-32_ARCHIVE\kr\08_rest_monitor.bat" /sc weekly /d MON,TUE,WED,THU,FRI /st 08:35 /rl HIGHEST /f
if errorlevel 1 (
...
schtasks /create /tn "Q-TRON_EOD_Cleanup" /tr "C:\Q-TRON-32_ARCHIVE\kr-legacy\99_eod_shutdown.bat" /sc weekly /d MON,TUE,WED,THU,FRI /st 16:00 /rl HIGHEST /f
if errorlevel 1 (
