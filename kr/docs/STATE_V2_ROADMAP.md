...
### 1순위: kr Core StateManager

**파일:** `kr/core/state_manager.py` (376줄)
...
### 2순위: us Core StateManagerUS

**파일:** `us/core/state_manager.py` (184줄)

**현재 구조:**
- kr Core와 동일한 two-file 패턴
...
- kr Core state_manager.py → shared import
- us → 별도 패키지 또는 복사 (다른 Python 환경)
