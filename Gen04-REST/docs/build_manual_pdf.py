...
def build_pdf(output_path: str):
    ...
    story.append(Paragraph(
        ...
        "Scope: Gen04-REST (KR) / Gen04-US (Alpaca) / Strategy Lab<br/>"
    ...
    story.append(make_table(
        ...
        [
            ...
            ["Gen04-REST", "KR (Lab + REST)", "pykrx / DB", "3.12 64-bit", "ACTIVE"],
            ["Gen04-US", "US (Russell 1000+)", "Alpaca REST", "3.12 64-bit", "ACTIVE (Paper)"],
        ],
    ...
    story.append(Paragraph(
        ...
        "&nbsp;&nbsp;Gen04/ ............. KR LIVE engine (Kiwoom COM, deletion planned)<br/>"
        "&nbsp;&nbsp;Gen04-REST/ ... KR REST API + Strategy Lab (9 strategies)<br/>"
        "&nbsp;&nbsp;Gen04-US/ ....... US Alpaca engine (paper/live)<br/>"
    ...
    story.append(make_table(
        ...
        [
            ...
            ["Python US", "C:\\Q-TRON-32_ARCHIVE\\Gen04-US\\.venv\\Scripts\\python.exe", "3.12 64-bit"],
            ["DB (KR)", "PostgreSQL (Gen04-REST/data/)", "OHLCV + fundamental"],
            ["DB (US)", "PostgreSQL (Gen04-US/)", "Separate tables"],
    ...
    story.append(Paragraph(
        ...
        "Python: Gen04-US/.venv/Scripts/python.exe (3.12 64-bit)<br/>"
        "Dashboard: http://localhost:8081 (FastAPI)",
        S_BODY))

    story.append(Paragraph("Commands", S_H3))
    story.append(Paragraph(
        "cd C:\\Q-TRON-32_ARCHIVE\\Gen04-US<br/><br/>"
        "# Connection test<br/>"
    ...
    story.append(Paragraph("Gen04-REST Core / Gen04-US Core", S_H3))
    story.append(Paragraph(
    ...
    story.append(Paragraph(
        "File: Gen04/monitor_gui_v2.py (1,736 lines)<br/>"
    ...
    story.append(Paragraph("REST Dashboard (Gen04-REST)", S_H2))
    story.append(Paragraph(
        "File: Gen04-REST/web/app.py (FastAPI)<br/>"
        "Port: 8080 (http://localhost:8080)<br/>"
        "Endpoints: /portfolio, /rebalance, /signals, /validate<br/>"
        "System tray: Gen04-REST/tray_server.py (green Q icon)",
        S_BODY))

    story.append(Paragraph("US Dashboard (Gen04-US)", S_H2))
    story.append(Paragraph(
    ...
    story.append(Paragraph("Gen04-REST (KR Lab + REST)", S_H2))
    story.append(make_table(
        ["Command", "Description"],
        [
    ...
    story.append(Paragraph("Gen04-US (Alpaca)", S_H2))
    story.append(make_table(
        ["Command", "Description"],
        [
    ...
    story.append(Paragraph("Batch Files (Gen04/)", S_H2))
    story.append(make_table(
        ["File", "Purpose"],
        [
    ...
    story.append(Paragraph(
        ...
        "Reference: Gen04-REST/docs/STATE_V2_ROADMAP.md",
        S_SUBTITLE))
