"""
strategy_health.py — KR strategy health (advisory stub)
=======================================================
...
Reconstructed after pre-commit stash incident (2026-04-20) wiped this file.
Mirrors us/risk/strategy_health.py (identical contract).

Contract (inferred from call sites in kr/main.py and kr/lifecycle/rebalance_phase.py):
